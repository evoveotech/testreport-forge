...
goal_template: "Stop iterating when the task meets all acceptance criteria for: find-skills"
...
```
Goal     -> Apply find-skills to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: find-skills
