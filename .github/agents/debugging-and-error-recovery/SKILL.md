...
goal_template: "Stop iterating when the task meets all acceptance criteria for: debugging-and-error-recovery"
...
```
Goal     -> Apply debugging-and-error-recovery to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: debugging-and-error-recovery
