...
goal_template: "Stop iterating when the task meets all acceptance criteria for: source-driven-development"
...
```
Goal     -> Apply source-driven-development to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: source-driven-development
...
- Evoveo Tech Agent-generated documentation or summaries
