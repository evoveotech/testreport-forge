...
goal_template: "Stop iterating when the task meets all acceptance criteria for: deprecation-and-migration"
...
```
Goal     -> Apply deprecation-and-migration to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: deprecation-and-migration
