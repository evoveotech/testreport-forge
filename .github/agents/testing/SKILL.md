...
goal_template: "Stop iterating when the task meets all acceptance criteria for: testing"
...
```
Goal     -> Apply testing to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: testing
