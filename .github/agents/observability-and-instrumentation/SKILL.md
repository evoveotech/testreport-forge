...
goal_template: "Stop iterating when the task meets all acceptance criteria for: observability-and-instrumentation"
...
```
Goal     -> Apply observability-and-instrumentation to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: observability-and-instrumentation
