...
goal_template: "Stop iterating when the task meets all acceptance criteria for: planning-and-task-breakdown"
...
```
Goal     -> Apply planning-and-task-breakdown to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: planning-and-task-breakdown
