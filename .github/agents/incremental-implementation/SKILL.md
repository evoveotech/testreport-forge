...
goal_template: "Stop iterating when the task meets all acceptance criteria for: incremental-implementation"
...
```
Goal     -> Apply incremental-implementation to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: incremental-implementation
