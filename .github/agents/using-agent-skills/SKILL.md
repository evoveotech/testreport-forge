...
goal_template: "Stop iterating when the task meets all acceptance criteria for: using-agent-skills"
...
```
Goal     -> Apply using-agent-skills to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: using-agent-skills
