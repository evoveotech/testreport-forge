...
goal_template: "Stop iterating when the task meets all acceptance criteria for: spec-mining"
...
```
Goal     -> Apply spec-mining to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: spec-mining
