...
goal_template: "Stop iterating when the task meets all acceptance criteria for: shipping-and-launch"
...
```
Goal     -> Apply shipping-and-launch to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: shipping-and-launch
