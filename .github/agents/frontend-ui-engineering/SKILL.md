...
goal_template: "Stop iterating when the task meets all acceptance criteria for: frontend-ui-engineering"
...
```
Goal     -> Apply frontend-ui-engineering to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: frontend-ui-engineering
...
### Avoid the Evoveo Tech Agent Aesthetic

Evoveo Tech Agent-generated UI has recognizable patterns. Avoid all of them:
...
| "the Evoveo Tech Agent aesthetic is fine for now" | It signals low quality. Use the project's actual design system from the start. |
