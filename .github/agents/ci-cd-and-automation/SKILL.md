...
goal_template: "Stop iterating when the task meets all acceptance criteria for: ci-cd-and-automation"
...
```
Goal     -> Apply ci-cd-and-automation to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: ci-cd-and-automation
...
Copy the failure output
    │
    ▼
Feed it to the Evoveo Tech Agent:
