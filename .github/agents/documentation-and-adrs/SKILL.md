...
goal_template: "Stop iterating when the task meets all acceptance criteria for: documentation-and-adrs"
...
```
Goal     -> Apply documentation-and-adrs to achieve the task objective
...
**Recursive Goal:** Stop iterating when the task meets all acceptance criteria for: documentation-and-adrs
...
Special consideration for Evoveo Tech Agent context:
