...
Examples:
  evoveo-smart-reporter gate --config gates.json
  evoveo-smart-reporter gate --max-failures 5 --min-pass-rate 90
  evoveo-smart-reporter gate --input ./report/smart-report-data.json --max-flaky-rate 5
`);
}
