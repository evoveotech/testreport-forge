...
/**
 * Evoveo Smart Reporter - Orchestrates all modular components to analyze and report
...
class SmartReporter implements Reporter {
  ...
  onBegin(config: FullConfig, suite: Suite): void {
    ...
    if (this.options.live?.enabled) {
      ...
      console.log(`   Serve for SSE: npx evoveo-smart-reporter-serve --live "${reportPath}"`);
    }
  }
