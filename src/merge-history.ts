...
function printUsage(): void {
  console.log(`
Usage: evoveo-smart-reporter-merge-history <history1.json> <history2.json> [...] -o <output.json>
...
Example:
  evoveo-smart-reporter-merge-history machine1/test-history.json machine2/test-history.json -o merged-history.json
`);
}
