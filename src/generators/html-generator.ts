...
${!branding?.hidePoweredBy ? '    <div>Powered by <a href="https://github.com/evoveotech/testreport-forge" style="color:var(--accent-blue);text-decoration:none;">Evoveo Smart Reporter</a></div>' : ''}
  </footer>` : ''}
</body>
</html>`;
