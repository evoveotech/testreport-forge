"""
JSON converter: pytest-json-report format -> Evoveo Smart Reporter format
"""
import json
...
def convert_pytest_json(pytest_json_path: Path) -> Dict[str, Any]:
    """
    Convert pytest JSON report to Evoveo Smart Reporter data format.

    Args:
        pytest_json_path: Path to pytest-json-report output file

    Returns:
        Dictionary in Evoveo Smart Reporter HtmlGeneratorData format
    """
