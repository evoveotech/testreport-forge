# Evoveo Smart Reporter - Python

Python integration for [Evoveo Smart Reporter](https://github.com/evoveotech/testreport-forge) - brings AI-powered failure analysis, flakiness detection, and beautiful HTML reports to your pytest test suites.

## Features

All the features from the main Evoveo Smart Reporter, now available for Python/pytest:
...
```python
from evoveo_smart_reporter_python import SmartReporterBridge
...
2. **Converter** transforms pytest JSON to Evoveo Smart Reporter format
...
- [Evoveo Smart Reporter (Node.js)](https://github.com/evoveotech/testreport-forge) - Main package
